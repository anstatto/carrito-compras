...
export default function DireccionForm({ onSuccess, direccionInicial }: DireccionFormProps) {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(direccionInicial?.id 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <select
              ...
              onChange={e => setFormData({ ...formData, provincia: e.target.value as ProvinciaRD })}
              className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 
                       focus:ring-4 focus:ring-pink-500/20 focus:border-pink-500 
                       transition-all duration-200 bg-white shadow-inner"
              required
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <select
              ...
              onChange={e => setFormData({ ...formData, agenciaEnvio: e.target.value as AgenciaEnvio })}
              className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 
                       focus:ring-4 focus:ring-pink-500/20 focus:border-pink-500 
                       transition-all duration-200 bg-white shadow-inner"
            >
          ...
          >
            ...
            <input
              ...
              onChange={e => setFormData({ ...formData, sucursalAgencia: e.target.value })}
              className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 
                       focus:ring-4 focus:ring-pink-500/20 focus:border-pink-500 
                       transition-all duration-200 bg-white shadow-inner"
            />
        ...
        >
          <div className="relative inline-block">
            <input
              ...
              onChange={e => setFormData({ ...formData, predeterminada: e.target.checked })}
          ...
          <span className="text-sm font-semibold text-gray-800">Dirección Predeterminada</span>
        </motion.div>
      </div>
